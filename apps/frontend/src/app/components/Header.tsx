...
export default function Header() {
  ...
  return (
    <header
      className={`max-w-4xl w-full flex items-center p-4 gap-2 h-13 bg-transparent text-white absolute top-0 left-0 z-20 justify-between sm:px-8 transition-transform duration-300 ${
