...
import { Music2, Heart, Clock, User, Sparkles, Play, Calendar, Filter, Search, Trash2, Star, AlertCircle, ChevronDown } from 'lucide-react';
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                ...
                                <div className='relative'>
                                    <select
                                        ...
                                        className="appearance-none pl-4 pr-11 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                                    >
                                ...
                                <div className='relative w-40'>
                                    ...
                                    <div className="pointer-events-none absolute inset-y-0 right-6 flex items-center text-black">
                                        <ChevronDown size={16} />
                                    </div>
                                </div>
                            </div>
